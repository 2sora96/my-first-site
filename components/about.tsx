...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"(주)일양로지스","period":"2023.08 - 현재","description":"회계팀"},{"icon":"briefcase","title":"(주)신영CNS","period":"2020.06 - 2022.07","description":"경영지원"},{"icon":"graduation","title":"홍익대학교","period":"2022.03 - 2026.02","description":"디자인경영학부"}],
    skills: [{"icon":"rocket","title":"목표 중심적인 실행력","description":"업무 비효율을 인식하고 실행으로 연결하여 업무 프로세스 개선 및 시간 절감 기여"},{"icon":"users","title":"부서 간 협업을 이끄는 소통","description":"조직간 이해와 커뮤니케이션을 바탕으로 회계 데이터 협업 및 조율 주도"},{"icon":"star","title":"경영지원 전반 이해도","description":"인사·총무·회계 등 경영지원 경험을 바탕으로 조직 전반 흐름을 이해하고 유연하게 대응"}],
    storyTitle: "About Me",
    story: ["저는 재무·회계 업무를 통해 회사와 팀의 의사결정을 더 정확하고 효율적으로 만드는 일에 열정을 가지고 있습니다.","반복되는 업무를 자동화하고 프로세스를 개선하여 팀 전체의 업무 효율과 정확성을 높이는 성과를 만들어왔습니다.","앞으로도 지속적인 학습과 개선을 통해, 정확성과 효율을 갖춘 일잘러 회계 실무자로 성장해 나가겠습니다."],
    storyImage: "/uploads/about-image-1756954376153.png",
    hobbies: ["✈️ 여행","🎬 영화 감상","✍️ 글쓰기","☕ 카페 투어"]
  }
