...
export function Hero() {
  ...
  // 초기 데이터 - 배열 형태로 변경
  const defaultSocialLinks = [{"name":"Instagram","icon":"linkedin","url":"https://www.linkedin.com/in/%EC%86%8C%EB%9D%BC-%EC%9D%B4-8a473a360?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"}]
  
  const defaultInfo = {
    greeting: "안녕하세요,",
    name: "이소라",
    title: "회계실무자",
    description: "일 잘하고 싶은 실무형 회계 전문가",
    profileImage: "/uploads/hero-profile-1756958845744.jpg",
    backgroundImage: "",
    backgroundVideo: "",
    backgroundOpacity: 0.1,
    projectButton: "프로젝트 보기",
    background: {"image":"","video":"","color":"#d7f8fe","opacity":0.1}
  }
