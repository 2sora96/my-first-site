...
export function Contact() {
  ...
  const defaultInfo = {
    ...
    experience: "4년 경력",
    phone: "010-4972-4292",
    email: "2sora96@naver.com",
    website: "https://www.linkedin.com/in/%EC%86%8C%EB%9D%BC-%EC%9D%B4-8a473a360?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
    location: "서울특별시 마포구",
    ...
    bottomMessage: "팀과 회사의 재무 효율과 정확성을 높이기 위해 최선을 다하겠습니다",
    bottomSubMessage: "비효율 개선과 협업 중심 실행력으로, 빠르게 성장하는 조직의 재무 체계를 안정화하는 데 기여할 준비가 되어 있습니다.",
  ...
  const defaultSocialLinks: { name: string; icon: string; url: string }[] = [
    {
      "name": "새 링크",
      "icon": "linkedin",
      "url": "https://www.linkedin.com/in/%EC%86%8C%EB%9D%BC-%EC%9D%B4-8a473a360?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
    },
    {
      "name": "새 링크",
      "icon": "mail",
      "url": "2sora96@naver.com"
    }
  ]
